$(document).ready(function() {
		...
		$('#calendar').weekCalendar({
			...
			eventRender : function(calEvent, $event) {
				...
				var colorometro={"1":"#2B72D0","0":"#000000","2":"#FF0000","3":"#33CC00","4":"#ff6600" };
				...
				$event.find(".wc-time").replaceWith('<div class="ntit ui-corner-top" style="background-color:'+col+'; border: 1px solid'+col+';">'+h1+":"+m1+" - "+h2+":"+m2+'</div>');
				}
			}, 
