...
#versione modificata per l'italiano
SMALL = 'a|an|and|as|at|but|by|en|for|if|in|of|on|or|the|to|v\.?|via|vs\.?|un|uno|una|i|e|o|come|di|a|da|in|con|su|per|tra|fra|il|lo|la|i|gli|le'
PUNCT = r"""!"#$%&'‘()*+,\-./:;?@[\\\]_`{|}~"""
